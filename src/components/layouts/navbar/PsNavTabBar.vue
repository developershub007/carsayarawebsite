<template>
    ...
    <nav class="flex fixed z-50 w-full h-8 lg:h-12 bg-navColor " 
        :class="topOfPage ? ' ' : 'hidden'">
        
        <div v-if="dataReady" class="flex flex-row justify-between items-center content-center text-textLight text-base w-mobile sm:w-median lg:w-large mx-auto" >
            <div class="flex justify-start items-center content-center" >
                <ps-label class="sm:text-xs text-xxs" textColor="text-textLight font-medium"><strong>Your ride is your Swag</strong></ps-label>
            </div>
                ...
                <ps-label v-on:click="toggleDarkMode" 
                    class="cursor-pointer flex flex-row">
                        <div class="mx-2 my-auto ">
                            <ps-label class="sm:text-xs text-xxs" textColor="text-textLight font-medium">Dark Mode</ps-label>
                        </div>
                        <div class="my-auto"> 
                            <img v-if="isDarkMode" src="@/assets/images/toggle_on.png" width="35px" height="35px" alt='toggle on' class="w-auto h-3 sm:h-4 cursor-pointer object-cover "/>
                            <img v-else src="@/assets/images/toggle_off.png" width="35px" height="35px" alt='toggle off' class="w-auto h-3 sm:h-4 cursor-pointer object-cover "/>
                        </div>
