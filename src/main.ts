...
import { manufacturerProviderSymbol, createManufacturerProviderState } from './store/modules/manufacturer/ManufacturerProvider';
...
createApp(App)
    ...
    .provide(manufacturerProviderSymbol, createManufacturerProviderState())
